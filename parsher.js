...
client.on("guildMemberAdd", member => {
  const hosgeldin = new Discord.MessageEmbed()
   ...
   .setColor("#00ff00")
    .addField("**Sunucu Adresimiz**", "[Tıkla ](https://discord.gg/2xNmbZ6AwJ)")
    .addField(
      "**YouTube kanalımız**",
      "[Tıkla ](https://tenor.com/tr/view/şaşkın-gif-18535442)"
    )
...
;
 client.on("ready", () => {
  client.channels.cache.get("1127588580013916190").join();   
})